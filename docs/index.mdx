...
against an OCI artifact. `Brain` implements the complete protocol, including hierarchical catalog
navigation.
...
| Authenticity: SSHSIG signatures, the trust root, positional revocation | Whose brain this is must be checkable mechanically, offline, by anyone |
