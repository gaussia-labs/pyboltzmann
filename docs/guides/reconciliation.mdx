...
| Conflict | Verdict |
| --- | --- |
| One side drops evidence the other derived from | Structurally invisible, semantically fatal. `REJECTED` by the evidence check |
...
written** — the reconciliation stops and waits for you.
