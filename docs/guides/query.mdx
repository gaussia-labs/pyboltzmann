...
Query(
    ...
    filters=QueryFilters(
        ...
        classes=[year_2025_id, fourier_id],  # catalog facets, AND + descendants
...
Catalog class filters are resolved from the semantic catalog and applied to canonical evidence. See
[Catalog and hierarchical navigation](/sdks/boltzmann/concepts/catalog) for declarations, hierarchy, and
path views such as `2025/fourier/examenes`.
